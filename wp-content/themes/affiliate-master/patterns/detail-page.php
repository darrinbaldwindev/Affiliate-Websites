<?php
/**
 * Title: Program or Product Detail Shell
 * Slug: affiliate-master/detail-page
 * Categories: featured
 * Inserter: true
 */
?>
...
<!-- wp:paragraph {"fontSize":"small"} --><p class="has-small-font-size">Opportunity detail</p><!-- /wp:paragraph -->
<!-- wp:post-title {"level":1} /-->
<!-- wp:paragraph {"fontSize":"large"} --><p class="has-large-font-size">A concise summary of what this option is and who it may suit.</p><!-- /wp:paragraph -->
<!-- wp:heading {"level":2} --><h2 class="wp-block-heading">Key facts</h2><!-- /wp:heading -->
...
<!-- wp:paragraph --><p>The commercial action is resolved by the governed affiliate/commercial layer. Do not place raw tracking URLs in editorial templates.</p><!-- /wp:paragraph -->
<!-- wp:pattern {"slug":"affiliate-master/affiliate-disclosure"} /-->
</div>
<!-- /wp:group -->
